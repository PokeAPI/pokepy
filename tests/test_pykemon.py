...
def base_get_test(self, resource, method="name"):
    """
    Base get test function for both V1Client and V2Client
...
def base_404_test(self, resource):
    """
    Base 404 error test function for both V1Client and V2Client
...
class TestV1Client(unittest.TestCase):
    ...
    def test_get_gg_resource(self):
        base_get_test(self, "egg")

    def test_get_description_resource(self):
        base_get_test(self, "description")

    def test_get_sprite_resource(self):
        base_get_test(self, "sprite")

    def test_get_game_resource(self):
        base_get_test(self, "game")
    ...
    def test_404_gg_resource(self):
        base_404_test(self, "egg")

    def test_404_description_resource(self):
        base_404_test(self, "description")

    def test_404_sprite_resource(self):
        base_404_test(self, "sprite")

    def test_404_game_resource(self):
        base_404_test(self, "game")
